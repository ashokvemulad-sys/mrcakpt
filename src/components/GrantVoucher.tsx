...
export const GrantVoucher = ({ record, grant, serialNo = 1 }: GrantVoucherProps) => {
  ...
  return (
    <div className="voucher-page max-w-[210mm] mx-auto bg-white p-[8mm] h-[297mm] print:p-[8mm] print:max-w-none print:h-[297mm] border-2 border-voucher-header flex flex-col overflow-hidden text-[12.5px] leading-relaxed text-foreground" style={{ fontFamily: "'AppNumerals', 'Bookman Old Style', 'URW Bookman L', 'Bookman', Georgia, serif" }}>
      {/* Header */}
