...
import { Search, Printer, X, FileText, Receipt, ScrollText, Save, RotateCcw, ClipboardCheck } from "lucide-react";
...
import { AuditFormReport } from "@/components/AuditFormReport";
    ...
    <>
      ...
      <div className="no-print fixed bottom-0 left-0 right-0 flex gap-2 flex-wrap justify-center py-4 border-t border-border bg-background/95 backdrop-blur shadow-lg z-50">
        ...
        <Button
          ...
          className="gap-2"
        >
          <ClipboardCheck className="h-4 w-4" /> Audit Form
        </Button>
